...
DETAILS:
  ...
  If count is to be specified, log_file must also be specified
  To show all lines specify count as 'all'
...
USAGE: cftail [-i] [-l] group pattern [log_file]
...
USAGE: cftail-request [-l] group request_id [log_file]
